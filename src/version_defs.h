...
#define SPACETHEORY_BUILDDATE			1493510792
#define SPACETHEORY_PRODUCTVERSION		0,17,429,70
#define SPACETHEORY_STRPRODUCTVERSION	"0.17.429.70\0"
...
#define SPACETHEORY_LOGFILE				L"engine.log"
